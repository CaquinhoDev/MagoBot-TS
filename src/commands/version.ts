...
export const command: StickerBotCommand = {
  ...
  run: async (
    ...
    const homepage = "https://github.com/caquinhodev/magobotts";
    ...
    if (latestVersion.version && localVersion) {
      ...
      response =
        `🤖 *{Ei|Ops|Opa|Desculpe|Foi mal}, não foi possível verificar se o ${bot.name} está atualizado! ` +
        `{🧐|🫠|🥲|🙃|❌}* ❌\n\n{🐙|😼} *GitHub:* ${homepage}\n👨🏻‍💻 *Desenvolvedor:* CaquinhoDev`;
    }
